class Rule:
    """
    This class handles all the chess pieces rules
    """
    def __init__(self):
    ...
    def findPieceOnCol(self, initial_pos, pieceList, increase):
        """
        This function go up or down a column looking for chess piece based on the Boolean increase

        :param initial_pos: Current position of the chess piece that is looking for another chess piece on the column
        :param pieceList: the current chess piece list
        :param increase: Boolean that decide whether the search go upward or downward of a column
        :return: chess piece if any is found on the column, else None
        """
        row = initial_pos[0]
        col = initial_pos[1]
        # print("Row: ",row)
    ...
    def findPieceOnRow(self, initial_pos, pieceList, increase):
        """
        This function go to left or right of a row looking for chess piece based on the Boolean increase

        :param initial_pos: Current position of the chess piece that is looking for another chess piece on the row
        :param pieceList: the current chess piece list
        :param increase: Boolean that decide whether the search go left or right of a row
        :return: chess piece if any is found on the column, else None
        """
        row = initial_pos[0]
        col = initial_pos[1]
